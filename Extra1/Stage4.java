...
public class Stage4 extends Application implements Initializable{
    ...
    /**
     * Flag para indicar si el boton de sonido esta en on o en off
     */
    ...
    public void initialize(URL url, ResourceBundle rb){
        ...
        soundButton.setSelected(soundFlag);
    }
    ...
    public void guardar(){
        try{
            ...
            soundFlag = soundButton.isSelected();
        }catch(Exception e){}
    }
