...
public class Pedestrian {
    ...
    /**
     * Metodo para saber si el individuo porta mascarilla
     * @return  true or false si el individuo tiene o no mascarilla respectivamente
     */
    ...
    public void infect(){ //infecta individuo
        ...
        if(state==State.S){ //Si el individuo era susceptible
            ...
            this.pedestrianView.infectedColor(this,1.0); //Cambiamos su representacion grafica
        }
        this.rec_time=SimulatorConfig.I_TIME; //El tiempo de recuperacion se inicia como el parametro
    }
    /**
